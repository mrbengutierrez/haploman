...
var html = '<nav class="navbar navbar-expand-md navbar-dark bg-dark navigation-bar">\
    ...
    <div class="collapse navbar-collapse" id="navbarToggler_01">\
      <ul class="navbar-nav ml-auto">\
        <li class="nav-item">\
          <a class="nav-link" href="http://www.haploman.com/education">Education</a>\
        </li>\
        <li class="nav-item">\
          <a class="nav-link" href="http://www.haploman.com/projects">Projects</a>\
        </li>\
        <li class="nav-item">\
          <a class="nav-link" href="http://www.haploman.com/#contact">Contact</a>\
        </li>\
      </ul>\
    </div>\
  </nav>\
